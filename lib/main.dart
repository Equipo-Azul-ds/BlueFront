  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: UserProviders(
        baseUrl: apiBaseUrl,
        child: MultiProvider(
          // Agregamos este MultiProvider para envolver la app con la Biblioteca vinculada al Auth
          providers: [
            ChangeNotifierProxyProvider<AuthBloc, LibraryProvider>(
              ...
              update: (context, authBloc, previous) => LibraryProvider(
                getCreated: context.read<GetCreatedKahootsUseCase>(),
                getFavorite: context.read<GetFavoriteKahootsUseCase>(),
                getInProgress: context.read<GetInProgressKahootsUseCase>(),
                getCompleted: context.read<GetCompletedKahootsUseCase>(),
            ...
            builder: (context) {
              return MaterialApp(
                ...
                scaffoldMessengerKey: context
                    ...
                    .messengerKey,
                theme: ThemeData(
                  // ... (Tu configuración de tema se mantiene igual)
                  fontFamily: 'Onest',
