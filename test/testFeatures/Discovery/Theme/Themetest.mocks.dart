...
// in Trivvy/test/testFeatures/Discovery/Theme/Themetest.dart.
...
import 'package:Trivvy/core/errors/failures.dart' as _i11;
import 'package:Trivvy/features/discovery/application/dto/ThemeListResponseDto.dart'
    as _i3;
import 'package:Trivvy/features/discovery/domain/entities/theme.dart' as _i12;
...
class _FakeThemeListResponseDto_3 extends _i1.SmartFake
    implements _i3.ThemeListResponseDto {
  _FakeThemeListResponseDto_3(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeThemeRemoteDataSource_4 extends _i1.SmartFake
    implements _i4.ThemeRemoteDataSource {
  _FakeThemeRemoteDataSource_4(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
/// A class which mocks [ThemeRemoteDataSource].
///
/// See the documentation for Mockito's code generation for more information.
class MockThemeRemoteDataSource extends _i1.Mock
    implements _i4.ThemeRemoteDataSource {
  MockThemeRemoteDataSource() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i2.Client get cliente =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeClient_2(this, Invocation.getter(#cliente)),
          )
          as _i2.Client);

  @override
  _i6.Future<_i3.ThemeListResponseDto> fetchThemes() =>
      (super.noSuchMethod(
            Invocation.method(#fetchThemes, []),
            returnValue: _i6.Future<_i3.ThemeListResponseDto>.value(
              _FakeThemeListResponseDto_3(
                this,
                Invocation.method(#fetchThemes, []),
              ),
            ),
          )
          as _i6.Future<_i3.ThemeListResponseDto>);
}

/// A class which mocks [ThemeRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockThemeRepository extends _i1.Mock implements _i10.ThemeRepository {
  MockThemeRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.ThemeRemoteDataSource get remoteDataSource =>
      (super.noSuchMethod(
            Invocation.getter(#remoteDataSource),
            returnValue: _FakeThemeRemoteDataSource_4(
              this,
              Invocation.getter(#remoteDataSource),
            ),
          )
